# $Id: ip.py,v 1.1.1.1 2005/10/29 18:20:48 provos Exp $

from dpkt import Packet, in_cksum as _ip_cksum, \
     in_cksum_add as _ip_cksum_add, in_cksum_done as _ip_cksum_done
...
import ah, esp, gre, icmp, icmp6, igmp, pim, tcp, udp

# XXX - prevent import cycle
IP._protosw.update({
    1:icmp.ICMP, 2:igmp.IGMP, 4:IP, 6:tcp.TCP, 17:udp.UDP, 47:gre.GRE,
    50:esp.ESP, 51:ah.AH, 58:icmp6.ICMP6, 103:pim.PIM
    })
